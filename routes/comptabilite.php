...
Route::get('/bus/zones/index', [ZoneController::class, 'index'])->name('admin_bus_zones_index');
Route::post('/bus/zones/ajouter', [ZoneController::class, 'ajouter'])->name('admin_bus_lzones_ajouter');
Route::get('/bus/zones/modifier/{id}', [ZoneController::class, 'modifier'])->name('admin_bus_zones_modifier');
Route::post('/bus/zones/update/{id}', [ZoneController::class, 'update'])->name('admin_bus_zones_update');
Route::post('/bus/zones/delete/{id}', [ZoneController::class, 'delete'])->name('admin_bus_zones_delete');
Route::get('/bus/zones/detail/{id}', [ZoneController::class, 'detail'])->name('admin_bus_zones_detail');
Route::get('/bus/zones/affecter', [ZoneController::class, 'affecter'])->name('admin_bus_zones_affecter');
Route::post('/bus/zones/affecter', [ZoneController::class, 'valider_affecter'])->name('admin_bus_ligne_valider_affecter');


     // 📂 Bus  Voitures


Route::get('/bus/voitures/index', [VoitureController::class, 'index'])->name('admin_bus_voitures_index');
Route::post('/bus/lignes/ajouter', [VoitureController::class, 'ajouter'])->name('admin_bus_voitures_ajouter');
Route::get('/bus/voitures/modifier/{id}', [VoitureController::class, 'modifier'])->name('admin_bus_voitures_modifier');
Route::post('/bus/voitures/update/{id}', [VoitureController::class, 'update'])->name('admin_bus_voitures_update');
Route::post('/bus/voitures/delete/{id}', [VoitureController::class, 'delete'])->name('admin_bus_voitures_delete');
Route::get('/bus/voitures/detail/{id}', [VoitureController::class, 'detail'])->name('admin_bus_voitures_detail');


     // 📂 Bus  Chauffeurs


Route::get('/bus/chauffeurs/index', [ChauffeurController::class, 'index'])->name('admin_bus_chauffeurs_index');
Route::post('/bus/chauffeurs/ajouter', [ChauffeurController::class, 'ajouter'])->name('admin_bus_chauffeurs_ajouter');
Route::get('/bus/chauffeurs/modifier/{id}', [ChauffeurController::class, 'modifier'])->name('admin_bus_chauffeurs_modifier');
Route::post('/bus/chauffeurs/update/{id}', [ChauffeurController::class, 'update'])->name('admin_bus_chauffeurs_update');
Route::post('/bus/chauffeurs/delete/{id}', [ChauffeurController::class, 'delete'])->name('admin_bus_chauffeurs_delete');
Route::get('/bus/chauffeurs/detail/{id}', [ChauffeurController::class, 'detail'])->name('admin_bus_chauffeurs_detail');
