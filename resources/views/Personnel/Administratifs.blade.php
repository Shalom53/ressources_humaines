...
DRH | Liste Du Personnel Administratif
        ...
        <div class="page-header">
            <div class="add-item d-flex">
                <div class="page-title">
                    <h4 class="fw-bold">Personnel Administratif </h4>
                    <h6>Liste Du Personnel Administratif   </h6>
                </div>
            </div>
...
@section('js')
    ...
    XLSX.writeFile(wb, "Personnel_Administratif.xlsx");
    });
    ...
    document.getElementById('exportPdf').addEventListener('click', function (e) {
        ...
        doc.save('Personnel_Administratif.pdf');
    });
