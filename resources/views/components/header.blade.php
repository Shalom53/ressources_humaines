        ...
        <ul class="nav user-menu">
            ...
            <li class="nav-item nav-searchinputs">
                <div class="top-nav-search">
                    <a href="{{url('/')}}" class="responsive-search">
                    ...
                    <form action="#" class="dropdown">
                        <div class="searchinputs input-group dropdown-toggle" id="dropdownMenuClickable" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                            ...
                            <span class="input-group-text">
										<kbd class="d-flex align-items-center"><img src="{{asset('app')}}/assets/img/icons/command.svg" alt="img" class="me-1">K</kbd>
									</span>
                        </div>
                        <div class="dropdown-menu search-dropdown" aria-labelledby="dropdownMenuClickable">
                            ...
                            <div class="search-info">
                                ...
                                <ul class="customers">
                                    <li><a href="javascript:void(0);">Aron Varu<img src="{{asset('app')}}/assets/img/profiles/avator1.jpg" alt="Img" class="img-fluid"></a></li>
                                    <li><a href="javascript:void(0);">Jonita<img src="{{asset('app')}}/assets/img/profiles/avatar-01.jpg" alt="Img" class="img-fluid"></a></li>
                                    <li><a href="javascript:void(0);">Aaron<img src="{{asset('app')}}/assets/img/profiles/avatar-10.jpg" alt="Img" class="img-fluid"></a></li>
                                </ul>
                            </div>
                        </div>
                    </form>
                   ...
                   data-bs-toggle="dropdown">
							<span class="user-info">
								...
								<span class="user-detail">
									<span class="user-name">2024-2025</span>
								</span>
							</span>
                </a>
            ...
            <li class="nav-item pos-nav">
                <a href="" class="btn btn-dark btn-md d-inline-flex align-items-center">
                    <i class="ti ti-device-laptop me-1"></i>SUKULI
                </a>
            </li>
                        ...
                        <ul class="notification-list">
                                ...
                                <a href="activities.html">
                                    <div class="media d-flex">
												<span class="avatar flex-shrink-0">
													<img alt="Img" src="{{asset('app')}}/assets/img/profiles/avatar-13.jpg">
												</span>
                            ...
                            <li class="notification-message">
                                <a href="activities.html">
                                    <div class="media d-flex">
												<span class="avatar flex-shrink-0">
													<img alt="Img" src="{{asset('app')}}/assets/img/profiles/avatar-03.jpg">
												</span>
                                        <div class="flex-grow-1">
                            ...
                            <li class="notification-message">
                                <a href="activities.html" class="recent-msg">
                                    <div class="media d-flex">
												<span class="avatar flex-shrink-0">
													<img alt="Img" src="{{asset('app')}}/assets/img/profiles/avatar-17.jpg">
												</span>
                                        <div class="flex-grow-1">
                            ...
                            <li class="notification-message">
                                <a href="activities.html" class="recent-msg">
                                    <div class="media d-flex">
												<span class="avatar flex-shrink-0">
													<img alt="Img" src="{{asset('app')}}/assets/img/profiles/avatar-02.jpg">
												</span>
                                        <div class="flex-grow-1">
            ...
            <li class="nav-item dropdown has-arrow main-drop profile-nav">
                <a href="javascript:void(0);" class="nav-link userset" data-bs-toggle="dropdown">
							<span class="user-info p-0">
								<span class="user-letter">
									<img src="{{asset('app')}}/assets/img/profiles/avator1.jpg" alt="Img" class="img-fluid">
								</span>
							</span>
                </a>
                <div class="dropdown-menu menu-drop-user">
                    <div class="profileset d-flex align-items-center">
								<span class="user-img me-2">
									<img src="{{asset('app')}}/assets/img/profiles/avator1.jpg" alt="Img">
								</span>
                        <div>
